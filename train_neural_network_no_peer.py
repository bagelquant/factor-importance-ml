# %% [markdown]
"""
# Train NeuralNetwork with Embeddings (No Peer Features)
...
from src.ml_backend import load_train_ready_data_no_peer, split_data, NeuralNetwork
...
results_path = Path("data/predictions/neural_network_no_peer_predictions.csv")
...
# save to a text file
time_log_path = Path("data/predictions/neural_network_no_peer_time_log.txt")
