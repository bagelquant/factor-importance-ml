# %% [markdown]
"""
# Train GradientBoostingTree with Embeddings (No Peer Features)

This script trains a GradientBoostingTree model using features augmented with:
...
from src.ml_backend import load_train_ready_data_no_peer, split_data, GradientBoostingTree
...
results_path = Path("data/predictions/gradient_boosting_no_peer_predictions.csv")
...
# save to a text file
time_log_path = Path("data/predictions/gradient_boosting_no_peer_time_log.txt")
