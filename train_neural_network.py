# %% [markdown]
"""
# Train NeuralNetwork with Embeddings

This script trains a NeuralNetwork model using features augmented with:
...
from src.ml_backend import load_train_ready_data, split_data, NeuralNetwork
...
for year in range(2009, test_end + 1):
    ...
    # Neural Networks generally require clean numeric input.
...
results_path = Path("data/predictions/neural_network_predictions.csv")
...
# save to a text file
time_log_path = Path("data/predictions/neural_network_time_log.txt")
