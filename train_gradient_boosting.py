# %% [markdown]
"""
# Train GradientBoostingTree with Embeddings
...
from src.ml_backend import load_train_ready_data, split_data, GradientBoostingTree
...
results_path = Path("data/predictions/gradient_boosting_predictions.csv")
...
# save to a text file
time_log_path = Path("data/predictions/gradient_boosting_time_log.txt")
